package com.redtek.rootsys.util.helpers;
...
public class NBTHelper {
  ...
  public static CompoundNBT toNBT(Object o) {
    ...
    if(o instanceof MinerTileEntity) {
      return writeMiner((MinerTileEntity)o);
    }

    return null;
  }

  private static CompoundNBT writeMiner(MinerTileEntity o) {
